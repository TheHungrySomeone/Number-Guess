# Number-Guess Game
This is a very simple number guessing game.  It asks for a nickname, asks you to guess a number, tells you if you're number is too high or to low, and tells you if you won.
## Dependencies
* Bash
